...
async function loadFavoriteMovies() {
  ...
  try {
    const response = await fetch(`http://localhost/movie_project/src/backend/server.php?controller=movie&method=getFavorites&token=Bearer%20${token}`);
...
async function removeFavorite(movieId) {
  ...
  try {
    const response = await fetch(`http://localhost/movie_project/src/backend/server.php?controller=movie&method=removeFavorite&movie_id=${movieId}&token=Bearer%20${token}`, {
      method: "DELETE",
      headers: {
...
async function loadWatchHistory() {
  ...
  try {
    const response = await fetch(`http://localhost/movie_project/src/backend/server.php?controller=movie&method=getWatchHistory&token=Bearer%20${token}`);
    const data = await response.json();
